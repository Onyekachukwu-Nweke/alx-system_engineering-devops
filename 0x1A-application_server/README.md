# Application Server
The files in this folder are tasks and resources pertaining to app server concepts

## Resources
- [App server vs Web server](https://www.nginx.com/resources/glossary/application-server-vs-web-server/)
...
- [API routes](https://flask.palletsprojects.com/en/1.0.x/api/#flask.Flask.route)